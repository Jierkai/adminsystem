    ...
    <el-row justify="space-between" type="flex">
      ...
      <el-col :span="13" style="padding-right:26px">
        ...
        <el-card class="box-card">
          ...
          <!-- 放置日历组件 -->
          <WorkCalendar :start-date.sync="nowDay" />
          <el-calendar v-model="nowDay">
          ...
          <div class="advContent">
            ...
            <div class="contentItem">
              <ul class="noticeList">
                <li>
                  <div class="item">
                    <img v-imageError="defaultImg" :src="staffPhoto" alt="">
                    <div>
...
import defaultImg from '@/assets/common/user-filling.png'
...
export default {
  name: 'Dashboard',
  components: { RadarChart, WorkCalendar },
  data() {
    return {
      defaultImg,
      nowDay: new Date()
